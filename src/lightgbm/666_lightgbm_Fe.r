...
setwd("/home/mauro/Escritorio/Facultad/Data Mining/DataMiningenEconomíayFinanzas" )    #establezco la carpeta donde voy a trabajar

#cargo el dataset
dataset  <- fread("./datasets/fe_paquete_premium_202009.csv")
...
dapply  <- fread("./datasets/fe_paquete_premium_202011.csv")
