...
setwd("~/Escritorio/Facultad/Data Mining/DataMiningenEconomíayFinanzas")  #Establezco el Working Directory
...
dtrain <- dtrain[,-c("tmobile_app","internet","tpaquete1","Master_madelantodolares" , "Visa_Finiciomora"  ,"Visa_mconsumosdolares" ,
...
parametros  <-  list( "cp"=-0.839110910899521, "minsplit"=1044,  "minbucket"=503, "maxdepth"=7 )

num_trees         <-  10    #voy a generar 10 arboles
feature_fraction  <-   0.7  #entreno cada arbol con solo 50% de las variables variables
