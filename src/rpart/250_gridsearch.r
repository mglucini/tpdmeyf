...
setwd("~/Escritorio/Facultad/Data Mining/DataMiningenEconomíayFinanzas/dmeyf/src/rpart")

ksemillas  <- c(122323, 192323, 232303, 22323, 252323) #reemplazar por las propias semillas

#------------------------------------------------------------------------------

loguear  <- function( reg, arch=NA, folder="~/Escritorio/Facultad/Data Mining/DataMiningenEconomíayFinanzas/work/work", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset  <- fread("~/Escritorio/Facultad/Data Mining/DataMiningenEconomíayFinanzas/datasetsOri/paquete_premium_202009.csv")
